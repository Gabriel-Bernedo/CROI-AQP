...
function x = FC_showView(app, view)
    ...
    case "1" % Click calculadora de consumo
        app.P_inicio_Instalacion.Visible = "off";
        app.P_Botones_Instalacion.Visible = "off";
        app.P_Botones_Instalacion_Hibrido.Visible = "off";
        app.P_Central_Solucion.Visible = "off";
        app.P_Central_Solucion_Hibrido.Visible = "off";
        app.P_inicio_1.Visible = 'on';
        app.P_Central_Recibos.Visible = 'off';
        ...
        app.P_Botones.Visible = 'off';
    case "1.1" % Click ingresar recibo
        app.P_Botones.Visible = 'on';
        app.P_Central_Recibos.Visible = 'on';
    ...
    case "1.2.1" % Click en añadir en Ingresar electrodomésticos
        app.P_Botones.Visible = 'on';
        app.P_Central_Electrodomesticos.Visible = 'on';
        app.P_inicio_1.Visible = 'off';
    ...
    case "1.3.1" % Click en Tendencias main
        ...
        app.P_Botones.Visible = 'on';
        app.P_Central_Recibos.Visible = 'off';
        app.P_Central_Electrodomesticos.Visible = 'off';
        app.P_Central_Tendencias.Visible = 'on';
